...
（1）$3|\overline{a_na_{n-1}\cdots a_0}$

$\Leftrightarrow3|(a_0\times10^0+a_1\times10+\cdots+a_n\times10^n)$.

由**引理1**得知 $9|(10^n-1)$，

所以 $3|(10^n-1)$，即 $10^n\equiv1(\mod3)$

所以 $3|(a_0\times10^0+a_1\times10+\cdots+a_n\times10^n)$.

$\Leftrightarrow3|(a_0+a_1+\cdots+a_n)$.

即**若一个整数的数字和能被 $3$ 整除，则这个数能被 $3$ 整除.**

（2）$9|\overline{a_na_{n-1}\cdots a_0}$

$\Leftrightarrow9|(a_0\times10^0+a_1\times10+\cdots+a_n\times10^n)$.

由**引理1**得知 $9|(10^n-1)$，即 $10^n\equiv1(\mod9)$

所以 $9|(a_0\times10^0+a_1\times10+\cdots+a_n\times10^n)$.

$\Leftrightarrow9|(a_0+a_1+\cdots+a_n)$.
...
$\Leftrightarrow7|10x-20a_0$

$\Leftrightarrow7|10x-20a_0+21a_0$

$\Leftrightarrow7|10x+a_0$

$\Leftrightarrow7|\overline{a_na_{n-1}\cdots a_0}$.

即**若一个整数的个位数字截去，再从余下的数中减去个位数的 $2$ 倍，如果差是 $7$ 的倍数，则原数能被 $7$ 整除. **

（2）$11|x-a_0$

$\Leftrightarrow11|10x-10a_0$

$\Leftrightarrow11|10x-10a_0+11a_0$

$\Leftrightarrow11|10x+a_0$

$\Leftrightarrow11|\overline{a_na_{n-1}\cdots a_0}$.

即**若一个整数的个位数字截去，再从余下的数中减去个位数，如果差是 $11$ 的倍数，则原数能被 $11$ 整除. **

（3）$13|x+4a_0$

$11\Leftrightarrow13|10x+40a_0$

$\Leftrightarrow13|10x+40a_0-13\times3a_0$

$\Leftrightarrow13|10x+a_0$

$\Leftrightarrow13|\overline{a_na_{n-1}\cdots a_0}$.

即**若一个整数的个位数字截去，再从余下的数中加上个位数的 $4$ 倍，如果和是 $13$ 的倍数，则原数能被 $13$ 整除. **

（4）$17|x-5a_0$

$\Leftrightarrow17|10x-50a_0$

$\Leftrightarrow17|10x-50a_0+17\times3a_0$

$\Leftrightarrow17|10x+a_0$

$\Leftrightarrow17|\overline{a_na_{n-1}\cdots a_0}$​.

即**若一个整数的个位数字截去，再从余下的数中减去个位数的 $5$ 倍，如果差是 $17$ 的倍数，则原数能被 $17$ 整除.**

（5）$19|x+2a_0$

$\Leftrightarrow19|10x+20a_0$

$\Leftrightarrow19|10x+20a_0-19a_0$

$\Leftrightarrow19|10x+a_0$

$\Leftrightarrow19|\overline{a_na_{n-1}\cdots a_0}$.
...
**证明**    由 $7\times11\times13=1001$ 可得 $7|1001,11|1001,13|1001$.
...
则  $7|\overline{a_na_{n-1}\cdots a_2 a_1 a_0}$

$\Leftrightarrow7|(1000x+\overline{a_2 a_1 a_0})$

$\Leftrightarrow7|(1001x-x+\overline{a_2 a_1 a_0})$

$\Leftrightarrow7|({\overline{a_2 a_1 a_0}}-x)$.
...
易知 $11|9\cdot11\cdot(10^{2k-2}+10^{2k-4}+\cdots+1)$，
...
**引理3** $11|(10^{2k+1}+1)(k\in\mathbb{N})$.
...
易知 $11|11(10^{2k}-10^{2k-1}+10^{2k-2}-\cdots+1)$，所以 $11|(10^{2k+1}+1)$.
...
$\Leftrightarrow11|((a_0(10^0-1)+a_0)+(a_1(10+1)-a_1)+\cdots+(a_n(10^n\pm1)\mp a_n))$

$\Leftrightarrow11|(a_0-a_1+\cdots\mp a_n)$，
